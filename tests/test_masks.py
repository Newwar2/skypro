...
@pytest.mark.parametrize(
    "type_card, real_result", [("1234567891234567", "1234 56** **** 4567"), (" ", "Некорректный номер карты")]
)
...
@pytest.mark.parametrize(
    "test_account, result_account", [("7000792289606361", "**6361"), ("123", "Некорректный номер счета")]
)
